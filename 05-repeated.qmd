...
Resultatene fra den parrede t-testen viser at det er en signifikant forskjell mellom ett og tre sett på lean mass i beina med en p-verdi på `r p.lean`. Som figuren viser, hadde begge beina et tilnærmet likt utgangspunkt ved pre-test. Begge beina har økt mengde lean mass fra pre til post, men det beinet som har trent tre sett har økt ytterligere.
